...
const leaderWorkerSetSidebarItemInjectable = getInjectable({
  id: "sidebar-item-leaderworkerset",
  ...
  instantiate: (di) => {
    ...
    return {
      ...
      isActive: computed(() => {
        ...
        return match?.params.group === "leaderworkerset.x-k8s.io" && match?.params.name === "leaderworkersets";
      }),
...
export default leaderWorkerSetSidebarItemInjectable;
